    ...
    <>
      ...
      <div className="navbar">
        <div className="Nav">
          ...
          <div className="pc_none">
            {/* <div className="nav py-3 mw-100"> */}
            <div className="nav container d-flex justify-content-center mw-100 px-0">
              <div className="logo_menu row mx-0">
                <div className="d-flex justify-content-between align-items-center px-3">
                  <Link to="#" className="menu-bars">
                    <div className="nav_menu_bar" onClick={showSidebar}>
                      <img
                  ...
                  <Link to="/" className="darlcha_text">
                    <div className="darlcha_logo d-flex px-0">
                      <p className="darlcha_text my-0">
                        DARL
                        <span>CHA</span>
                      </p>
      ...
      <div className={sidebar ? "nav-menu active" : "nav-menu"}>
        <ul className="nav-menu-items" onClick={showSidebar}>
          ...
          <li className="nav-text">
            <a href="https://smartstore.naver.com/darlcha">
              <span>네이버스토어</span>
            </a>
          </li>
          <li className="nav-text">
            <a href="https://www.instagram.com/darlcha.official">
              <span>인스타그램</span>
            </a>
          </li>
          <li className="nav-text">
            <a href="https://www.amazon.com/stores/FAKE.+Coffee+-+Zero+Caffeine/page/65B26C8C-3993-41CF-A8B9-ADF2A87591B5?ref_=ast_bln">
              <span>Amazon</span>
            </a>
          </li>
        </ul>
