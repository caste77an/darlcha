...
function Nav() {
  return (
    <div className="Nav">
      <div className="nav_bar pt-5 px-5">
        <div className="container mx-0 px-5 mw-100">
        ...
        <div className="container mx-0 px-5 mw-100">
          <div className="nav row my-3 mx-0">
            <div className="col-3"></div>
            <div className="col-6 d-flex px-0">
              <div className="col-md-offset-3 col-md-2">
                <p className="text-center my-0">전체 상품</p>
              </div>
              <div className="col-md-2">
                <p className="text-center my-0">정기구매</p>
              </div>
              <div className="col-md-2">
                <p className="text-center my-0">브랜드 스토리</p>
              </div>
              <div className="col-md-2">
                <p className="text-center my-0">네이버스토어</p>
              </div>
              <div className="col-md-2">
                <p className="text-center my-0">인스타그램</p>
              </div>
              <div className="col-md-2">
                <p className="text-center my-0">Amazon</p>
              </div>
            </div>
            <div className="col-3"></div>
          </div>
